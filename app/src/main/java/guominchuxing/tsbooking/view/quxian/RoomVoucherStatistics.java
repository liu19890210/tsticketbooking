package guominchuxing.tsbooking.view.quxian;
...
public class RoomVoucherStatistics extends View implements OnTouchListener {
    ...
    public RoomVoucherStatistics(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public RoomVoucherStatistics(Context context) {
        super(context);
        CircleR = DensityUtil.dip2px(context, 3);
        bottomH = DensityUtil.dip2px(context, 12);
        topH = DensityUtil.dip2px(context, 16);
    ...
    private void initView() {
        ...
        yPaint.setColor(Color.rgb(255, 255, 255));
        ...
        paintText.setColor(getResources().getColor(R.color.textColot));//Color.rgb(255, 255, 255));
