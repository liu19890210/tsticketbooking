package guominchuxing.tsbooking.view.date;
...
public class MonthDateView extends View {
	...
	private int mSelectBGColor = Color.parseColor("#2F98E9");
	...
	protected void onDraw(Canvas canvas) {
		...
		for(int day = 0;day < mMonthDays;day++){
			...
			if(dayString.equals(mSelDay+"")){
				...
				rectF.left = mColumnSize * column;
				rectF.right = startRecX + mColumnSize;
				rectF.top = startRecY + mRowSize;
				rectF.bottom = mRowSize * row;
