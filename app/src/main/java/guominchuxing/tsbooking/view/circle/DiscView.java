//package guominchuxing.tbooking.view.circle;
//
...
//        mCircleView.isBottomCircleShow = a.getBoolean(R.styleable.DiscView_dvBottomCircleIsShow, true);
...
//        setValue(value, ANIMATION_DURING,str);
//    }
//
//    /**
//     * 设置指示器的值 min - max之间
...
//     * @param value
//     */
//    public void setValue(int value, int duration, final String str) {
...
//
//                mCircleView.setValue(value,str);
