...
public class YesterdayFragment extends LazyFragment {
    ...
    private void getHistoryVoucher(int numOfPage, int currentPage) {
        ...
        String yesdayDate = DateUtils.format(DateUtils.getYesdayDate(new Date()),"yyyy-MM-dd");
        subscription = ApiManager.getDefaut().getHistoryVoucher(
                token,yesdayDate,date,Const.ODYCREATETIME,Const.APP,Const.METHOD)
...
//        Log.e(TAG,date);
//        ApiManager.getToday(token,date,Const.TYPE, Const.APP)
//                .subscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new Action1<HistoryBean>() {
//                    @Override
//                    public void call(HistoryBean todayBean) {
//
//                        Log.e(TAG,todayBean.toString());
//                        try {
//                            int code = todayBean.getCode();
//                            String msg = todayBean.getMsg();
//                            if (){
//                                List dataList = numberBean.getData();
//                                if (dataList !=null && !dataList.isEmpty()){
//                                    tv_noList.setVisibility(View.GONE);
//                                    recyclerViewList.setVisibility(View.VISIBLE);
//                                    adapter = new NumberAdapter(getActivity(),dataList);
//                                    recyclerViewList.setAdapter(adapter);
//                                }else {
//                                    recyclerViewList.setVisibility(View.GONE);
//                                    tv_noList.setVisibility(View.VISIBLE);
//                                    tv_noList.setText("目前没找到您验完的房券！");
//                                }
//                            }else if (code == 905){
//                                setUnDialog(msg);
//                            }else {
